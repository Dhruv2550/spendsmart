...
export const Dashboard: React.FC<DashboardProps> = ({ monthlySavings, expenseLimit }) => {
  ...
  const defaultWidgets: Widget[] = [
    ...
    { id: 'recent-transactions', title: 'Recent Transactions', visible: true, size: 'large', order: 5 },
    { id: 'expense-categories', title: 'Top Expense Categories', visible: true, size: 'large', order: 6 },
